require([
  ...
  'MethylationPlugin/View/Track/Wiggle/MethylHTMLPlot',
  ...
  describe('Initalize track', function () {
    ...
    describe('Initalize html track', function () {
    var track = new MethylHTMLPlot({
      browser: new Browser({
        unitTestMode: true
      }),
      config: {
  ...
  describe('functioning store', function () {
    ...
    it('feature bigwig values', function () {
      var cg = array.filter(features, function (f) {
        return f.get('source') === "cg";
      });
      //console.log(JSON.stringify(cg));
      var chg = array.filter(features, function (f) {
        return f.get('source') === "chg";
      });
      var chh = array.filter(features, function (f) {
        return f.get('source') === "chh";
      });
